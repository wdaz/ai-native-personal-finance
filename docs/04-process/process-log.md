...
- **Lesson:** a generic checklist's "how to test" hints needed changing in twelve rows once read against this repository's ADRs and specs. A second agent that reads those documents before approving is the cheap check.
