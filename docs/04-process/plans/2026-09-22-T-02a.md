...
Status: **Done** — executed as T-02a and merged (PR #1, 2026-09-22 UTC, merge `b02fbd7`); until then it read **Draft**, and the rest of this line and the text below are the plan as it stood at hand-over, not rewritten (v0.3 — all five plan-gate answers of 2026-09-22 applied; awaiting the go-ahead) · Author(s): Agent (Claude Code, Opus 5) · Date: 2026-09-22
