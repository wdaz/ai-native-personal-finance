...
Status: **Done** — executed as T-01 and merged (PR #1, before the repository move restarted the numbering, 2026-09-20 UTC, merge `2f4acdd`); until then it read **Draft**, and the rest of this line and the text below are the plan as it stood at hand-over, not rewritten · Author(s): Agent (Claude Code, Opus 5) · Date: 2026-09-20
