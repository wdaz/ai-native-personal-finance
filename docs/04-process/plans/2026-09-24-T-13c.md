...
Status: **Draft — the owner answered Q1–Q6 on 2026-09-25; awaiting the go-ahead and the execution
method** (v0.2 — 2026-09-25: the answers are recorded and Task 3 is rewritten for Q4 = a linter;
v0.1 — 2026-09-24) · Author(s): Agent (Claude Code) · Date: 2026-09-24
...
> it.** The owner's answers are in "Questions and the owner's answers"; what is still open is the
> go-ahead ("start") and the execution method.
>
