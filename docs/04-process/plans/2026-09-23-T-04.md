...
Status: **Done** — executed as T-04 and merged (PR #10, 2026-09-23 UTC, merge `15f6650`); until then it read **Draft**, and the rest of this line and the text below are the plan as it stood at hand-over, not rewritten (v0.2 — the owner's plan-gate answers of 2026-09-23 applied; waiting for the F1 PR and the go-ahead) · Author(s): Agent (Claude Code, Opus 5.5) · Date: 2026-09-23
