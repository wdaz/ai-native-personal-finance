...
- Status: **Accepted** (amended; clarified 2026-09-23 and 2026-09-24) · Date: 2026-09-13 · Author(s): Agent (proposal; carries forward the prior attempt's ADR-0002 thinking), Owner (decision)
...
- Clarification 2026-09-24 — **Accepted by the owner, 2026-09-24** (T-13 plan gate, Q6; wording accepted after T-13 merged: "Qəbul edirəm. Amma növbəti releasdə öz əksini tapmalıdır." — "Accepted. But it must be reflected in the next release."): the traceability script checks the stories of the release being built — `docs/03-specs/release-1-stories.txt`, generated from PRD §5 — instead of every id in `user-stories.md`; an id in a test title that `user-stories.md` does not define also fails it. The next release regenerates the list: the owner's condition — when Release 2 spec work opens, a Release 2 list is generated and the script reads the release being built (handed to T-15, backlog v1.23).
