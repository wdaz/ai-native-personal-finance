...
/**
 * T-01 smoke test, updated by T-05: `/` no longer renders a page — the proxy redirects
 ...
 */
test("scaffold: the root route redirects to /login, which renders under the CSP (proxy boots)", async ({
  page,
}) => {
  await page.goto("/");
